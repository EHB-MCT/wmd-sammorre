...
- To report security vulnerabilities, please email sam.morre@student.ehb.be which is monitored by our team.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/yourusername/wmd-sammorre.git
   cd wmd-sammorre
   ```

2. **Set up environment variables**
   - Copy the provided template: `cp .env.template .env`
...
- Include documentation in the repo or README.
...
For urgent matters, you can email sam.morre@student.ehb.be.